...
<body>
	<div class="row">
		...
		<div class="col-md-9">
			<div class="container">
			<div  id="vacancyForm"  style="margin-top:8%"></div>
			</div>
		</div>
	</div>
</body>
...
<jsp:include page="../template/form-template.jsp">
	<jsp:param name="formContainerId" value="vacancyForm" />
	<jsp:param name="formId" value="vacancyForm" />
	<jsp:param name="cancelPage" value="vacancy_list" />
	<jsp:param name="successPage" value="vacancy_list" />
</jsp:include>
